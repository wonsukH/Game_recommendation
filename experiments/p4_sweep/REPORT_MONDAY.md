...
> **유형**: experiment-report · **상태**: active · **갱신**: 2026-07-04 18:04 (토 v4 — 유저 크롤 재개 첫날 실측)
...
- **유저 적립(07-04 첫날 실측)**: 09:53 예산 리셋 재개 → 오전 discovery(234k 대기열 선별) → 13시부터 심층 수집 전환, **1,669 → 1,805 (+136, 실측 ~28명/h)**. **10k ETA 대략 13~16일**(90k콜/일 전량 유저 기준 일 500~600명 추정 — 단 첫날 관측이라 유동적: 스노볼 풀의 공개율·라이브러리 크기 분포에 따라 변동). 크롤러 사망 총 1회(07-03 12:06, 복구·이후 안정), 예산 일자는 UTC(리셋 = KST 09시) 확인.

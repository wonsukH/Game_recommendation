...
## 결정해주셔야 할 것 (교정·우선순위순)
1. **랭커(강건 결과, T36 정정)**: **EASE(λ≈100)로 교체 권고** — 공정 재평가상 최강(NDCG +0.061 SIG vs userknn, 독립축 최상위권, fit 0.9s). condcos(프로덕션)는 양축 최하. userknn/knnpd03은 2군 대안. *유의: EASE는 유저수³ 비용(현 1.1k=초 단위)이라 10k서도 저렴; 규모 확대 시 재확인.*

...
## Popularity-debiased @50 (drop relevant in top-5% popularity)

Phase 0 flagged the metric as popularity-confounded; this removes the 'easy' popular hits so the metric rewards finding non-obvious co-play neighbors.

| variant | recall@50 (debiased) [CI] |
|---|---|
| V0_random | 0.006 [0.003,0.009] |
| V1_popularity | 0.000 [0.000,0.000] |
| tagset_jaccard | 0.238 [0.216,0.263] |
| Vb_tagcosine | 0.249 [0.225,0.276] |
| Vc_ppmi_svd | 0.197 [0.175,0.221] |
| Vd_ensemble | 0.197 [0.175,0.221] |

| comparison (debiased) | Δrecall [CI] | significant |
|---|---|---|
| Vc_ppmi_svd vs Vb_tagcosine (debiased) | -0.052 [-0.073,-0.032] | True |
| Vb_tagcosine vs V1_popularity (debiased) | +0.249 [+0.225,+0.276] | True |

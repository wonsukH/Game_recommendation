...
STAGES: tuple[Stage, ...] = (
    ...
    Stage("pipeline.game_rec.data.game_weights",     "MinMax + gamma -> game_weight.npy"),
    ...
    Stage("pipeline.game_rec.models.game_vectors",   "synthesize game vectors -> game_vecs.npy"),
